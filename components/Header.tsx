...
export default function Header({
  ...
  return (
    <header className="border-b border-slate-800/60 bg-[#0B0F17]/80 backdrop-blur-2xl sticky top-0 z-40 px-3 sm:px-6 lg:px-8 py-2.5 sm:py-3 w-full min-w-0 shadow-lg shadow-black/40 relative">
      {/* Subtle bottom gradient hairline */}
      <div className="absolute bottom-0 inset-x-0 h-[1px] bg-gradient-to-r from-transparent via-cyan-500/30 to-transparent pointer-events-none" />
        ...
        <div className="flex items-center gap-1.5 sm:gap-2.5 shrink-0">
          ...
          {onOpenBackgroundModal && (
            <button
              ...
              className="flex items-center gap-1.5 px-2.5 sm:px-3 py-1.5 rounded-xl bg-cyan-950/40 hover:bg-cyan-900/50 border border-cyan-500/30 hover:border-cyan-400 text-xs font-semibold text-cyan-200 transition-all active:scale-95 cursor-pointer shadow-sm shadow-cyan-500/10"
